...
export default function BulkActions({
  selectedCount, totalCount, onDelete, onDownload, onDownloadZip, onCopyLinks, onBatchRename, onCopy, onDuplicate, onCreateZip, onMoveToFolder, onSelectAll, onDeselectAll,
}: Props) {
